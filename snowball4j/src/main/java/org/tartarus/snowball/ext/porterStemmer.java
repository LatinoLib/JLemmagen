...
private static final long serialVersionUID = 1L;
        ...
        //private final static porterStemmer methodObject = new porterStemmer ();
                ...
                private final static MyAmong a_3[] = {
                    ...
                    new MyAmong ( "abli", -1, 4 ),
                    new MyAmong ( "eli", -1, 6 ),
                    new MyAmong ( "alli", -1, 9 ),
                    new MyAmong ( "ousli", -1, 12 ),
                    new MyAmong ( "entli", -1, 5 ),
                    new MyAmong ( "aliti", -1, 10 ),
                    new MyAmong ( "biliti", -1, 14 ),
                    new MyAmong ( "iviti", -1, 13 ),
                    new MyAmong ( "tional", -1, 1 ),
                    new MyAmong ( "ational", 10, 8 ),
                    new MyAmong ( "alism", -1, 10 ),
                    new MyAmong ( "ation", -1, 8 ),
                    new MyAmong ( "ization", 13, 7 ),
                    new MyAmong ( "izer", -1, 7 ),
                    new MyAmong ( "ator", -1, 8 ),
                    new MyAmong ( "iveness", -1, 13 ),
                    new MyAmong ( "fulness", -1, 11 ),
                    new MyAmong ( "ousness", -1, 12 )
                };

                private final static MyAmong a_4[] = {
                    new MyAmong ( "icate", -1, 2 ),
                    new MyAmong ( "ative", -1, 3 ),
                    new MyAmong ( "alize", -1, 1 ),
                    new MyAmong ( "iciti", -1, 2 ),
                    new MyAmong ( "ical", -1, 2 ),
                    new MyAmong ( "ful", -1, 3 ),
                    new MyAmong ( "ness", -1, 3 )
                };
