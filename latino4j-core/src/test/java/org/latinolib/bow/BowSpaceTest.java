...
public class BowSpaceTest
{
    ...
    public static final String DOCUMENT = "know how to pursue pleasure rationally encounter consequences that are extremely painful. Nor again is there These cases are perfectly simple and easy to distinguish. In a free hour, when our power principle of selection: he rejects pleasures to secure other greater pleasures, or else he endures";
    public static final Map<String, DotNetIdxDat[]> DOT_NET_RESULTS;

    static {
        InputStream stream = BowSpaceTest.class.getResourceAsStream("dotnet_test_output.json");
